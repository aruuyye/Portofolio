...
<head>  
 ...
 <link rel="stylesheet" href="css/allhome.css"><link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
...
<amp-sidebar id="sidebar" class="cid-rIduZ5xEHs" layout="nodisplay" side="right">
        <div class="builder-sidebar" id="builder-sidebar">
            ...
            <div class="sidebar mbr-white" data-app-modern-menu="true"><hr>
              ...
              <a class="text-primary display-3" href="tukang_cukur/signinkcbar.php"><img src=icon/icnbar.jpg width=29px height=38px> Masuk Tukang Cukur</a><hr>
