...
<body><amp-sidebar id="sidebar" class="cid-rIduZ5xEHs" layout="nodisplay" side="right">
        <div class="builder-sidebar" id="builder-sidebar">
            ...
            <div class="sidebar mbr-white" data-app-modern-menu="true"><hr>
              <a class="text-primary display-3" href="index.php"><img src=icon/icnber.jpg width=32px height=38px> Beranda</a><hr>
              <a class="text-primary display-3" href="daftar-pelanggan.php"><img src=icon/icndafpel.jpg width=32px height=38px> Daftar Pelanggan</a><hr>
              <a class="text-primary display-3" href="daftar-tukang-cukur.php"><img src=icon/icndafbar.jpg width=32px height=38px> Daftar Tukang Cukur</a><hr>
            </div>
        </div>
    </amp-sidebar>
...
<br><br>
<form class="box" method="post" action="admin_login.php">
<input type="text" name="username" value="" placeholder="Pengguna Otoritas">
<input type="password" name="password" value="" placeholder="Kata Kunci Otoritas">
<p class="submit"><input type="submit" name="commit" value="Login">
<?php if(isset($_GET["login_error"])){ echo "<h2 style='color:red';>Username atau password salah</h2>"; } ?></form>
<br><br>
</section>
